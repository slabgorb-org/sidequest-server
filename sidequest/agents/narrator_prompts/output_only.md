...
npcs_present: Array of NPC mentions from this turn's prose. Format each entry:
  {"name": "<NPC or group name>", "role": "<hostile|friendly|neutral|merchant|ally|patron|quest_giver|...>", "pronouns": "<she/her|he/him|they/them|it/its>", "appearance": "<short physical/attire note>", "is_new": true, "side": "player|opponent|neutral", "is_creature": false}
