...
class DungeonTransaction(Protocol):
    ...
    def put_frontier(self, fe: FrontierEdge, *, site_id: str = ...) -> None: ...

    def record_mutation(
        self, region_id: str, kind: str, payload: dict, *, site_id: str = ...
    ) -> None: ...
    ...
    def open_thread(self, thread: ComplicationThread, *, site_id: str = ...) -> None: ...

    def open_threads(self, *, site_id: str = ...) -> list[ComplicationThread]: ...
...
class DungeonRepository(Protocol):
    ...
    # campaign_seed
    def get_campaign_seed(self, *, site_id: str = ...) -> int | None: ...

    def set_campaign_seed(self, seed: int, *, site_id: str = ...) -> None: ...
    ...
    def load_map(self, *, entrance_id: str, site_id: str = ...) -> RegionGraph: ...

    def load_masks(self, *, site_id: str = ...) -> dict[str, dict]: ...

    # frontier
    def put_frontier(self, fe: FrontierEdge, *, site_id: str = ...) -> None: ...

    def load_frontier(self, *, site_id: str = ...) -> list[FrontierEdge]: ...
    ...
    def load_mutations(self, *, site_id: str = ...) -> list[DungeonMutation]: ...

    # complication ledger
    def open_thread(self, thread: ComplicationThread, *, site_id: str = ...) -> None: ...

    def get_thread(self, thread_id: str, *, site_id: str = ...) -> ComplicationThread: ...

    def open_threads(self, *, site_id: str = ...) -> list[ComplicationThread]: ...

    def resolve_thread(self, thread_id: str, *, site_id: str = ...) -> None: ...
