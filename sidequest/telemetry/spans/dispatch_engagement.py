...
SPAN_DISPATCH_ENGAGEMENT_COURSE_MISMATCH = "dispatch_engagement.course.mismatch"
SPAN_DISPATCH_ENGAGEMENT_DOGFIGHT_MISMATCH = "dispatch_engagement.dogfight.mismatch"
...
for _name in (
    ...
    SPAN_DISPATCH_ENGAGEMENT_COURSE_MISMATCH,
    SPAN_DISPATCH_ENGAGEMENT_DOGFIGHT_MISMATCH,
):
...
_SUBSYSTEM_TO_SPAN_NAME: dict[str, str] = {
    ...
    "course": SPAN_DISPATCH_ENGAGEMENT_COURSE_MISMATCH,
    "dogfight": SPAN_DISPATCH_ENGAGEMENT_DOGFIGHT_MISMATCH,
}
